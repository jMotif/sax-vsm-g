 ...
 * 
 */
public class SAXVSMContinuousGrammarSampler2 {
  ...
  private static SAXVSMGrammarCVErrorFunction2 function;
  ...
  static {
    consoleLogger = (Logger) LoggerFactory.getLogger(SAXVSMContinuousGrammarSampler2.class);
  ...
  private static String printHelp() {
    ...
    sb.append("An execution example: $java -cp \"sax-vsm-classic20.jar\" net.seninp.saxvsm.direct.SAXVSMDirectSampler");
  ...
  private static void classify(int[] params, NumerosityReductionStrategy strategy) throws Exception {
    ...
    List<WordBag> bags = RePairFactory.labeledSeries2ConcatenatedGrammarWordBags(trainData, windowSize,
  ...
  private static int[] sample(NumerosityReductionStrategy strategy) {
    ...
    function = new SAXVSMGrammarCVErrorFunction2(trainData, HOLD_OUT_NUM, strategy,
